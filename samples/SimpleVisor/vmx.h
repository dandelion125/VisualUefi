...
typedef enum _VMX_EXIT_REASONS {
	...
	EXIT_REASONS_MAX
} VMX_EXIT_REASONS, *PVMX_EXIT_REASONS;
...
typedef enum _MOV_CR_ACCESS_TYPE {
	MOV_CR_ACCESS_TYPE_TO_CR = 0,
	MOV_CR_ACCESS_TYPE_FROM_CR,
	MOV_CR_ACCESS_TYPE_CLTS,
	MOV_CR_ACCESS_TYPE_LMSW,
} MOV_CR_ACCESS_TYPE, *PMOV_CR_ACCESS_TYPE;

// TODO: Define/Include ULONG_PTR normally, this is a temporary hack!
typedef UINT64 ULONG_PTR;
typedef ULONG_PTR * PULONG_PTR;

typedef union _MovCrQualification {
	ULONG_PTR all;
	struct {
